package com.ecnu.trivia.common.component.web;
...
public enum HttpRespCode implements Serializable {
    ...
    METHOD_NOT_ALLOWED("405", "请求方法无法响应"),           //接口的方法请求错误，如以post请求get接口
    ...
    PORT_ALREADY_IN_USE("403", "端口已被占用"),
