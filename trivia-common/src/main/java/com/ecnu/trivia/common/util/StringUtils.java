/**
 * Created by Jack Chen at 2014/6/30
 */
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * 移除两边的#
     */
    public static String removePoundBracket(String str) {
        return removeBothChar(str, '#', '#');
    }
     ...
     * 移除两边的:
     */
    public static String removeColonBracket(String str) {
        return removeBothChar(str, ':', ':');
    }
    ...
    public static int countStr(String totalStr, String word) {
